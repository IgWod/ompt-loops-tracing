 ...
 *************************************************************************
 *                                                                       * 
 * Changes to parameters and create_seq function made by I. Wodiany 2020 * 
 *                                                                       * 
 *************************************************************************/
...
#pragma omp parallel private(x,s,i,k)
  ...
  // Line below changed by I. Wodiany
  k = (1 << 12);
...
#else
    #pragma omp parallel for private(i,j,k,k1) schedule(dynamic, 1)
#endif
